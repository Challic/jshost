(function(global) {
    global.$_Tawk_AccountKey = '5ec5a3ee6f7d401ccbb8756e';
    ...
    (function(u) {
        ...
        try {
            ...
            wa.prototype.log = function(a, b) {
                var d;
                b && a && (b.uiVersion = "v3", b.buildVersion = "685", b.buildCommit = "86f9abc644b13b30dda810ff2a38ad8ee5872404", d = {
                    type: a,
                    data: b
            ...
            var W = TawkClass.extend({
                ...
                buildView: function() {
                    ...
                    f.isEmbedded || !f.isDesktopRectangle() || f.isPopup ? a.className = "notShown" : a.className =
                        "headerBoxLink"
                },
                toggleUploadsAction: function() {
                    ...
                    c && (f.showUploads() ? (c.style.display = "block", this.container.attachUserEventListener("change", function(c) {
                            ...
                            if (c && c.length) {
                                for (var g = 0; g < c.length; g++) c[g].size > a.maxSizeFileUpload ? f.push(c[g]) : g >= a.maxNumberFileUpload ? e.push(c[g]) : b.viewHandler.startUpload(c[g]);
                                b.viewHandler.checkUploadFileWarning(f,
                                    e)
                            }
                        ...
                        this.container.attachUserEventListener("dragleave", c, "innerWrapper", "textareaContainerDragLeave"), this.container.attachUserEventListener("dragend", c, "innerWrapper", "textareaContainerDragEnd"), this.container.attachUserEventListener("drop", function(c) {
                            ...
                            var f = [],
                                e = [];
                            if (c && 0 !== c.length) {
                                for (var g = 0; g < c.length; g++) c[g].size > a.maxSizeFileUpload ? f.push(c[g]) : g >= a.maxNumberFileUpload ?
                                    e.push(c[g]) : b.viewHandler.startUpload(c[g]);
                                b.viewHandler.checkUploadFileWarning(f, e)
                            }
                ...
                toggleRatingAction: function() {
                    ...
                    a && c && (f.showRating() ? (a.style.display = "block", this.container.attachUserEventListener("mouseover", function() {
                            ...
                            c.style.display = "none"
                        }, "rateMainWrapper", "rateMainWrapperOut"),
                ...
                attachEvents: function() {
                    ...
                    if (y) {
                        ...
                        setTimeout(function() {
                            f.value ? (e.style.display = "none", k.className = k.className.replace("additionalPadding",
                                ""), n.removeClass(k, "additionalPadding")) : (e.style.display = "block", k.className += " additionalPadding ", n.addClass(k, "additionalPadding"))
                        }, 0);
                        b.chatHandler.sendTextPreview(d)
            ...
            var la = z.extend({
                ...
                updateViewByStatus: function(a) {
                    this._super(a);
                    e && ("preChatForm" !== b.formHandler.currentForm && "offlineForm" !== b.formHandler.currentForm) && f.isPopup && (a = m.getShortMessage(a), document.title = a ? L.pageName() + " - " + n.rawDecode(a) :
                        L.pageName())
                },
                handleEndChat: function() {
                    e.chatEnded();
            ...
            X.prototype.init = function() {
                ...
                if ("XMLHttpRequest" in g && "withCredentials" in new XMLHttpRequest && (x.cookieEnabled && !this.isDocumentReady) && (this.isDocumentReady = !0, c =
                    ...
                    y ? (f.isPopup ? b.viewHandler = new la : this.initRenderer(y), b.formHandler = new M) : (b.formHandler = new M, b.viewHandler = new jb);
            ...
            X.prototype.extractRegisterData = function(a) {
                a.wdgt && (a.wdgt.lc !== u.widgetSettings.lc && (this.waitingForLanguage = !0, n.insertScript("https://static-v.tawk.to/685/languages/" + a.wdgt.lc + ".js")), m.processSettings(a.wdgt));
